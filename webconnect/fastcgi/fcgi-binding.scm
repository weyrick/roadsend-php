...
;     (macro FCGI_stdin::int "FCGI_stdin")
;     (macro FCGI_stdout::int "FCGI_stdout")
;     (macro FCGI_stderr::int "FCGI_stderr")
...
;     (macro FCGI_fread::size_t (void* size_t size_t FCGI_FILE*) "FCGI_fread")
;     (macro FCGI_fwrite::size_t (void* size_t size_t FCGI_FILE*) "FCGI_fwrite")
