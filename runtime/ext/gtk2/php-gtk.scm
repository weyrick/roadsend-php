...
(define (init-php-gtk-lib)
   (debug-trace 0 "classes")
   (init-define-classes)
   (debug-trace 0 "gdk enums")
   (init-gdk-enums-lib)
   (debug-trace 0 "gtk enums")
   (init-gtk-enums-lib)
...
;;; work.
(register-extension "gtk2" "1.0.0"
                    "php-gtk2" (cond-expand 
...
(defmethod GtkAccelGroup (__construct)
...
(def-pgtk-methods GtkWidget gtk_widget
   ...
   (unparent)
   (unmap)
   ((translate_coordinates :return-type gboolean) (dest_widget :gtk-type GtkWidget*) (src_x :gtk-type gint) (src_y :gtk-type gint) (dest_x :gtk-type gint*) (dest_y :gtk-type gint*))
   (thaw_child_notify)
   (style_get_valist (first_property_name :gtk-type const-gchar*) (var_args :gtk-type va_list))
   (style_get_property (property_name :gtk-type const-gchar*) (value :gtk-type GValue*))
   (style_get (first_property_name :gtk-type const-gchar*))
   ...
   (set_size_request (width :gtk-type gint) (height :gtk-type gint))
   ...
   (set_redraw_on_allocate (redraw_on_allocate :gtk-type gboolean))
   (set_parent_window (parent_window :gtk-type GdkWindow*))
   (set_parent (parent :gtk-type GtkWidget*))
   (set_no_show_all (no_show_all :gtk-type gboolean))
   (set_name (name :gtk-type const-gchar*))
   (set_extension_events (mode :gtk-type GdkExtensionMode))
   (set_events (events :gtk-type gint))
   (set_double_buffered (double_buffered :gtk-type gboolean))
   (set_direction (dir :gtk-type GtkTextDirection))
;   (set_default_direction (dir :gtk-type GtkTextDirection))
;   (set_default_colormap (colormap :gtk-type GdkColormap*))
   (set_composite_name (name :gtk-type const-gchar*))
   (set_colormap (colormap :gtk-type GdkColormap*))
   (set_child_visible (is_visible :gtk-type gboolean))
   (set_app_paintable (app_paintable :gtk-type gboolean))
   (set_accel_path (accel_path :gtk-type const-gchar*) (accel_group :gtk-type GtkAccelGroup*))
   (set (first_property_name :gtk-type const-gchar*))
   ((send_expose :return-type gint) (event :gtk-type GdkEvent*))
   (reset_shapes)
   (reset_rc_styles)
   (reparent (new_parent :gtk-type GtkWidget*))
;   ((render_icon :return-type GdkPixbuf*) (stock_id :gtk-type const-gchar*) (size :gtk-type GtkIconSize) (detail :gtk-type const-gchar*))
   (remove_mnemonic_label (label :gtk-type GtkWidget*))
   ((remove_accelerator :return-type gboolean) (accel_group :gtk-type GtkAccelGroup*) (accel_key :gtk-type guint) (accel_mods :gtk-type GdkModifierType))
   ((region_intersect :return-type GdkRegion*) (region :gtk-type GdkRegion*))
   ((ref :return-type GtkWidget*))
   (realize)
...
;   (push_colormap (cmap :gtk-type GdkColormap*))
;   (pop_composite_child)
;   (pop_colormap)
   (path (path_length :gtk-type guint*) (path :gtk-type gchar**) (path_reversed :gtk-type gchar**))
   (modify_text (state :gtk-type GtkStateType) (color :gtk-type GdkColor*))
   (modify_style (style :gtk-type GtkRcStyle*))
   (modify_font (font_desc :gtk-type PangoFontDescription*))
   (modify_fg (state :gtk-type GtkStateType) (color :gtk-type GdkColor*))
   (modify_bg (state :gtk-type GtkStateType) (color :gtk-type GdkColor*))
   (modify_base (state :gtk-type GtkStateType) (color :gtk-type GdkColor*))
   ((mnemonic_activate :return-type gboolean) (group_cycling :gtk-type gboolean))
   (map)
   ((list_mnemonic_labels :return-type GList*))
   ((list_accel_closures :return-type GList*))
   ((is_focus :return-type gboolean))
   ((is_ancestor :return-type gboolean) (ancestor :gtk-type GtkWidget*))
   ((intersect :return-type gboolean) (area :gtk-type GdkRectangle*) (intersection :gtk-type GdkRectangle*))
   ((hide_on_delete :return-type gboolean))
   (hide_all)
   (hide)
   ((has_screen :return-type gboolean))
   (grab_focus)
   (grab_default)
   ((get_visual :return-type GdkVisual*))
   ((get_toplevel :return-type GtkWidget*))
   ((get_style :return-type GtkStyle*))
   (get_size_request (width :gtk-type gint*) (height :gtk-type gint*))
   ((get_settings :return-type GtkSettings*))
;   ((get_screen :return-type GdkScreen*))
   ((get_root_window :return-type GdkWindow*))
   (get_pointer (x :gtk-type gint*) (y :gtk-type gint*))
   ((get_parent_window :return-type GdkWindow*))
   ((get_parent :return-type GtkWidget*))
   ((get_pango_context :return-type PangoContext*))
   ((get_no_show_all :return-type gboolean))
   ((get_name :return-type const-gchar*))
   ((get_modifier_style :return-type GtkRcStyle*))
   ((get_extension_events :return-type GdkExtensionMode))
   ((get_events :return-type gint))
   ((get_display :return-type GdkDisplay*))
   ((get_direction :return-type GtkTextDirection))
;   ((get_default_visual :return-type GdkVisual*))
;   ((get_default_style :return-type GtkStyle*))
;   ((get_default_direction :return-type GtkTextDirection))
;   ((get_default_colormap :return-type GdkColormap*))
   ((get_composite_name :return-type gchar*))
   ((get_colormap :return-type GdkColormap*))
   ((get_clipboard :return-type GtkClipboard*) (selection :gtk-type GdkAtom))
   ((get_child_visible :return-type gboolean))
   (get_child_requisition (requisition :gtk-type GtkRequisition*))
   ((get_ancestor :return-type GtkWidget*) (widget_type :gtk-type GType))
   ((get_accessible :return-type AtkObject*))
   (freeze_child_notify)
   ((event :return-type gboolean) (event :gtk-type GdkEvent*))
   (ensure_style)
   (draw (area :gtk-type GdkRectangle*))
   (destroyed (widget_pointer :gtk-type GtkWidget**))
   (destroy)
   ((create_pango_layout :return-type PangoLayout*) (text :gtk-type const-gchar*))
   ((create_pango_context :return-type PangoContext*))
   (class_path (path_length :gtk-type guint*) (path :gtk-type gchar**) (path_reversed :gtk-type gchar**))
   (child_notify (child_property :gtk-type const-gchar*))
   ((child_focus :return-type gboolean) (direction :gtk-type GtkDirectionType))
   ((can_activate_accel :return-type gboolean) (signal_id :gtk-type guint))
   (add_mnemonic_label (label :gtk-type GtkWidget*))
   (add_events (events :gtk-type gint))
   (add_accelerator (accel_signal :gtk-type const-gchar*) (accel_group :gtk-type GtkAccelGroup*) (accel_key :gtk-type guint) (accel_mods :gtk-type GdkModifierType) (accel_flags :gtk-type GtkAccelFlags))
   ((activate :return-type gboolean))
   ((selection_remove_all :c-name gtk_selection_remove_all))
   ((selection_owner_set :return-type gboolean :c-name gtk_selection_owner_set) (selection :gtk-type GdkAtom) (time :gtk-type guint32))
   ((selection_convert :return-type gboolean :c-name gtk_selection_convert) (selection :gtk-type GdkAtom) (target :gtk-type GdkAtom) (time :gtk-type guint32))
   ((selection_clear_targets :c-name gtk_selection_clear_targets) (selection :gtk-type GdkAtom))
   ((selection_clear :return-type gboolean :c-name gtk_selection_clear) (event :gtk-type GdkEventSelection*))
   ...
   ((rc_get_style :return-type GtkStyle* :c-name gtk_rc_get_style))
   ((propagate_event :c-name gtk_propagate_event) (event :gtk-type GdkEvent*))
   ((menu_get_for_attach_widget :return-type GList* :c-name gtk_menu_get_for_attach_widget))
   ((grab_remove :c-name gtk_grab_remove))
   ((grab_add :c-name gtk_grab_add))
   ((drag_unhighlight :c-name gtk_drag_unhighlight))
   ((drag_source_unset :c-name gtk_drag_source_unset))
   ((drag_source_set_target_list :c-name gtk_drag_source_set_target_list) (target_list :gtk-type GtkTargetList*))
   ((drag_source_set_icon_stock :c-name gtk_drag_source_set_icon_stock) (stock_id :gtk-type const-gchar*))
   ((drag_source_set_icon_pixbuf :c-name gtk_drag_source_set_icon_pixbuf) (pixbuf :gtk-type GdkPixbuf*))
   ...
   ((drag_source_get_target_list :return-type GtkTargetList* :c-name gtk_drag_source_get_target_list))
   ((drag_source_add_text_targets :c-name gtk_drag_source_add_text_targets))
   ((drag_highlight :c-name gtk_drag_highlight))
   ((drag_get_data :c-name gtk_drag_get_data) (context :gtk-type GdkDragContext*) (target :gtk-type GdkAtom) (time :gtk-type guint32))
   ((drag_dest_unset :c-name gtk_drag_dest_unset))
   ((drag_dest_set_target_list :c-name gtk_drag_dest_set_target_list) (target_list :gtk-type GtkTargetList*))
   ...
   ((drag_dest_get_target_list :return-type GtkTargetList* :c-name gtk_drag_dest_get_target_list))
   ((drag_dest_find_target :return-type GdkAtom :c-name gtk_drag_dest_find_target) (context :gtk-type GdkDragContext*) (target_list :gtk-type GtkTargetList*))
   ((drag_dest_add_uri_targets :c-name gtk_drag_dest_add_uri_targets))
   ((drag_dest_add_text_targets :c-name gtk_drag_dest_add_text_targets))
   ((drag_dest_add_image_targets :c-name gtk_drag_dest_add_image_targets))
   ((drag_check_threshold :return-type gboolean :c-name gtk_drag_check_threshold) (start_x :gtk-type gint) (start_y :gtk-type gint) (current_x :gtk-type gint) (current_y :gtk-type gint))
...
;;; GtkButton
;;; =========
(defmethod GtkButton (__construct #!optional label)
...
(defmethod gtkcalendar (__construct)
...
(defmethod gtkdrawingarea (__construct)
...
(defmethod gtkpixmap (__construct pixmap mask)
...
(defmethod gtkpreview (__construct type)
...
(defmethod gtkstatusbar (__construct)   
...
(defmethod GtkArrow (__construct arrow_type shadow_type)
   (gtk-object-init! $this
		     (gtk_arrow_new
...
(defmethod gtkclist (__construct columns titles)
...
(defmethod gtkfixed (__construct)
...
(defmethod gtklayout (__construct #!optional hadj vadj)
...
(defmethod gtknotebook (__construct)
...
(defmethod GtkTable (__construct #!optional (rows 1) (columns 1) (homogeneous? FALSE))
   (gtk-object-init! $this
...
(defmethod gtkalignment (__construct xalign yalign xscale yscale)
...
(defmethod gtkeventbox (__construct)
...
(defmethod gtkhandlebox (__construct)
...
(defmethod gtkscrolledwindow (__construct #!optional hadj vadj)
   (gtk-object-init! $this
...
(defmethod gtkviewport (__construct #!optional hadj vadj)
   (gtk-object-init! $this
...
(def-pgtk-methods GtkWindow gtk_window
   ...
   (set_skip_taskbar_hint (setting :gtk-type gboolean))
   (set_skip_pager_hint (setting :gtk-type gboolean))
;   (set_screen (screen :gtk-type GdkScreen*))
   (set_role (role :gtk-type const-gchar*))
   (set_resizable (resizable :gtk-type gboolean))
   ...
   (set_mnemonic_modifier (modifier :gtk-type GdkModifierType))
   (set_keep_below (setting :gtk-type gboolean))
   (set_keep_above (setting :gtk-type gboolean))
   (set_icon_name (name :gtk-type const-gchar*))
   (set_icon_list (list :gtk-type GList*))
   (set_icon_from_file (filename :gtk-type const-gchar*) (error :gtk-type GError**))
   (set_icon (icon :gtk-type GdkPixbuf*))
   (set_has_frame (setting :gtk-type gboolean))
   (set_gravity (gravity :gtk-type GdkGravity))
   (set_geometry_hints (geometry_widget :gtk-type GtkWidget*) (geometry :gtk-type GdkGeometry*) (geom_mask :gtk-type GdkWindowHints))
   (set_frame_dimensions (left :gtk-type gint) (top :gtk-type gint) (right :gtk-type gint) (bottom :gtk-type gint))
   (set_focus_on_map (setting :gtk-type gboolean))
   (set_focus (focus :gtk-type GtkWidget*))
   (set_destroy_with_parent (setting :gtk-type gboolean))
   (set_default_size (width :gtk-type gint) (height :gtk-type gint))
;   (set_default_icon (icon :gtk-type GdkPixbuf*))
   (set_default (default_widget :gtk-type GtkWidget*))
   (set_decorated (setting :gtk-type gboolean))
;   (set_auto_startup_notification (setting :gtk-type gboolean))
   (set_accept_focus (setting :gtk-type gboolean))
   (resize (width :gtk-type gint) (height :gtk-type gint))
   (reshow_with_initial_size)
   (remove_mnemonic (keyval :gtk-type guint) (target :gtk-type GtkWidget*))
   (remove_embedded_xid (xid :gtk-type guint))
   (remove_accel_group (accel_group :gtk-type GtkAccelGroup*))
   ((propagate_key_event :return-type gboolean) (event :gtk-type GdkEventKey*))
   (present)
   ((parse_geometry :return-type gboolean) (geometry :gtk-type const-gchar*))
   (move (x :gtk-type gint) (y :gtk-type gint))
   ((mnemonic_activate :return-type gboolean) (keyval :gtk-type guint) (modifier :gtk-type GdkModifierType))
   (maximize)
   ((is_active :return-type gboolean))
   (iconify)
   ((has_toplevel_focus :return-type gboolean))
   ((get_type_hint :return-type GdkWindowTypeHint))
   ((get_transient_for :return-type GtkWindow*))
   ((get_title :return-type const-gchar*))
   ((get_skip_taskbar_hint :return-type gboolean))
   ((get_skip_pager_hint :return-type gboolean))
   (get_size (width :gtk-type gint*) (height :gtk-type gint*))
;   ((get_screen :return-type GdkScreen*))
   ((get_role :return-type const-gchar*))
   ((get_resizable :return-type gboolean))
   (get_position (root_x :gtk-type gint*) (root_y :gtk-type gint*))
   ((get_modal :return-type gboolean))
   ((get_mnemonic_modifier :return-type GdkModifierType))
   ((get_icon_name :return-type const-gchar*))
   ((get_icon_list :return-type GList*))
   ((get_icon :return-type GdkPixbuf*))
   ((get_has_frame :return-type gboolean))
   ((get_gravity :return-type GdkGravity))
   (get_frame_dimensions (left :gtk-type gint*) (top :gtk-type gint*) (right :gtk-type gint*) (bottom :gtk-type gint*))
   ((get_focus_on_map :return-type gboolean))
   ((get_focus :return-type GtkWidget*))
   ((get_destroy_with_parent :return-type gboolean))
   (get_default_size (width :gtk-type gint*) (height :gtk-type gint*))
   ((get_decorated :return-type gboolean))
   ((get_accept_focus :return-type gboolean))
   (fullscreen)
   (deiconify)
   ...
   (add_mnemonic (keyval :gtk-type guint) (target :gtk-type GtkWidget*))
   (add_embedded_xid (xid :gtk-type guint))
   (add_accel_group (accel_group :gtk-type GtkAccelGroup*))
   ((activate_key :return-type gboolean) (event :gtk-type GdkEventKey*))
   ((activate_focus :return-type gboolean))
   ((activate_default :return-type gboolean))
   ((tooltips_get_info_from_tip_window :return-type gboolean :c-name gtk_tooltips_get_info_from_tip_window) (tooltips :gtk-type GtkTooltips**) (current_widget :gtk-type GtkWidget**))
   )
;; (def-pgtk-methods GtkWindow gtk_window
...
(defmethod GtkWindow (__construct #!optional (type GTK_WINDOW_TOPLEVEL))
...
(defmethod gtkadjustment (__construct value lower upper step-increment page-increment page-size)
   (gtk-object-init! $this
...
(defmethod GtkTooltips (__construct)
...
(defmethod gtkhbox (__construct #!optional (homogenous FALSE) (spacing 0))
...
(defmethod gtkvbox (__construct #!optional (homogenous FALSE) (spacing 0))
...
(defmethod gtkdialog (__construct)
...
(defmethod gtkplug (__construct socket_id)
...
(defmethod gtkinputdialog (__construct)
...
(defmethod gtktipsquery (__construct)
...
;;; GtkEntry->GtkEntry
(defmethod GtkEntry (__construct)
...
(defmethod gtkoptionmenu (__construct)
...
(defmethod gtkcolorselection (__construct)
...
;;; GtkCombo->GtkCombo
(defmethod GtkCombo (__construct)
...
(defmethod GtkCTree (__construct columns tree-column #!optional titles)
...
(defmethod gtkcurve (__construct)
...
(defmethod gtkgammacurve (__construct)
...
(defmethod gtkhbuttonbox (__construct)
...
(defmethod gtkhpaned (__construct)
...
(defmethod gtkhruler (__construct)
...
(defmethod gtkhscale (__construct #!optional adj)
...
(defmethod gtkhscrollbar (__construct #!optional adj)
...
(defmethod gtkhseparator (__construct)
...
(defmethod gtkmenubar (__construct)
...
(defmethod GtkProgressBar (__construct #!optional adj)
...
(defmethod gtkspinbutton (__construct #!optional adjustment (climb-rate 0.0) (digits 0))
   (gtk-object-init! $this
...
(defmethod gtktearoffmenuitem (__construct)
...
(defmethod gtkvbuttonbox (__construct)
...
(defmethod gtkvpaned (__construct)
...
(defmethod gtkvruler (__construct)
...
(defmethod gtkvscale (__construct #!optional adjustment)
   (gtk-object-init! $this
...
(defmethod gtkvscrollbar (__construct #!optional adjustment)
   (gtk-object-init! $this 
...
(defmethod gtkvseparator (__construct)
...
(defmethod gtkallocation (__construct x y width height)
