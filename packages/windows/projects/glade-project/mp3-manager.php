...
/***
 *
 * This is a sample PHP-GTK project that uses Glade
 *
 * Glade provides an interface for rapidly creating GUI dialog boxes
 * and loading them into your PHP-GTK program.
 *
 * More information on PHP-GTK can be found here:
 * http://gtk.php.net
 *
 * More information on working with Glade can be found here:
 * http://gtk.php.net/manual/en/gladeclasses.php
 *
 * You can run Glade by clicking Tools->Glade GUI Designer in the main menu.
 * You can also add .glade files to your project and double click on them in
 * the Project File List to open them in Glade.
 *
 * The entry point into the project is the Main File, which you can set in
 * Project Properties.
 *
 * The project can be Compiled and Run by clicking the green Play button above.
